...
public class AccountPrincipal implements OAuth2User, UserDetails {
    ...
    public AccountPrincipal(Long id, String email, String password, Collection<? extends GrantedAuthority> authorities) {
        this.id = id;
        this.email = email;
    ...
    public static AccountPrincipal create(Account account) {
        ...
        //TODO : getAccountId() used in place of getId() ? is it correct ?
